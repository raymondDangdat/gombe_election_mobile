...
const keepMeLoggedInConstant = "keepMeLoggedIn";
const String notificationAvailable = "notificationAvailable";
...
final currencyFormat = [
  FilteringTextInputFormatter.allow(RegExp("[0-9.$nairaSign]")),
];
